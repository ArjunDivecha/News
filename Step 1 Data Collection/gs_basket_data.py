...
- API Credentials: client_id and client_secret (from .env file)
...
REQUIREMENTS:
- Valid Goldman Sachs API credentials (in .env file)
...
if not client_id or not client_secret:
    print("❌ GS_CLIENT_ID and GS_CLIENT_SECRET must be set in .env file")
    exit(1)
