...
ACCOUNT_NAMES = {
    ...
    ("Schwab", "36563696"): "Muni",  # Schwab nickname is "AA", but "Muni" is
                                     # the correct report name (user-confirmed
                                     # 2026-07-15) — holds the muni ladder,
                                     # SNAXX and cash being deployed
